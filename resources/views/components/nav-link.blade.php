...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-purple-400 text-sm font-medium leading-5 text-purple-300  focus:outline-none focus:border-purple-700 transition duration-150 ease-in-out'
