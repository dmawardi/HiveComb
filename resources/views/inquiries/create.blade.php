<x-layout>
    ...
    <x-honeycomb-float>
        ...
        <div class="w-10/12 mx-auto relative z-40 bg-gray-200 rounded shadow-lg">
            <div class="container mx-auto px-4 py-4 mt-6">
                <h1 class="text-3xl font-bold text-center mb-8 mt-4">Contact Us</h1>
                <form action="{{ route('inquiries.store') }}" method="POST" class="max-w-3xl mx-auto">
                    ...
                    <div class="mb-4">
                        <label for="website" class="block text-gray-700 text-sm font-bold mb-2">Website
                            (Optional)</label>
